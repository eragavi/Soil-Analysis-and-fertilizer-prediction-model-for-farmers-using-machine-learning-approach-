...
public class NutrientMainActivity5 extends AppCompatActivity {
    ImageView image;
    TextView t1;
    TextView t2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) C0360R.layout.nutrient_activity_main5);
        setSupportActionBar((Toolbar) findViewById(C0360R.id.toolbar));
        this.t2 = (TextView) findViewById(C0360R.id.text3);
        this.t2.setText("தென்னை -  இரும்பு சத்து குறைபாடு ");
        byte[] bytes = getIntent().getByteArrayExtra("BMP");
        Bitmap bmp = BitmapFactory.decodeByteArray(bytes, 0, bytes.length);
        this.image = (ImageView) findViewById(C0360R.id.imageView4);
        this.image.setImageBitmap(bmp);
        this.t1 = (TextView) findViewById(C0360R.id.text4);
